...
SLUG_EN: [url友好格式，如 "meta-ads-post-click-optimization-2025"]
FOCUS_KW_EN: [与 PRIMARY_KEYWORD 一致或略短]

SEO_TITLE_ZH: [中文标题，含核心关键词]
META_DESC_ZH: [中文 meta 描述]
SLUG_ZH: [英文 slug + "-zh" 后缀，如 "meta-ads-post-click-optimization-2025-zh"]
FOCUS_KW_ZH: [中文焦点关键词]
```
...
params:
  title: { raw: EN_TITLE }
  content: { raw: EN_CONTENT_HTML }
  excerpt: { raw: EN_EXCERPT }
  status: "publish"
  slug: SLUG_EN
  categories: [132592]
  meta:
    jetpack_seo_html_title: SEO_TITLE_EN
    advanced_seo_description: META_DESC_EN
...
params:
  title: { raw: ZH_TITLE }
  content: { raw: ZH_CONTENT_HTML }
  excerpt: { raw: ZH_EXCERPT }
  status: "publish"
  slug: SLUG_ZH
  categories: [132594]
  meta:
    jetpack_seo_html_title: SEO_TITLE_ZH
    advanced_seo_description: META_DESC_ZH
```

> **注意**：wpcom-mcp 支持 `jetpack_seo_html_title` 和 `advanced_seo_description` 作为 SEO meta 字段。
> Rank Math 的焦点关键词需在 WordPress 后台手动设置，或通过 Application Password + REST API 写入。
